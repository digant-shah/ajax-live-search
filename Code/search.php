...
$html = '';
$html .= '<li class="result" id="searchresult1">';
$html .= '<a href="#">';
$html .= '<h3 id="searchresult">nameString</h3>';
...
if (strlen($search_string) >= 1 && $search_string !== ' ') {
	// Build Query
	$query = 'SELECT * FROM directory WHERE name LIKE "%'.$search_string.'%"';
...
$('.searchresult1').live('click',function(){
var text1 = $(this).find('#searchresult');
console.log(text1);
});
</script>